...
const BUILTIN_PROFANITY: string[] = [
  ...
  "damn","dick","douchebag","fag","faggot","fuck","fucking","goddamn","hell",
  "jackass","jerk","motherfucker","nigga","nigger","piss","prick","pussy",
  "shit","slut","twat","whore","wanker","retard","retarded","spic","chink",
  "gook","kike","wetback","beaner","tranny","dyke","coon","cracker","honky",
  "gringo","skank","hoe","thot","dipshit","shithead","asshat","dumbass",
  "fatass","smartass","badass","kickass","horseshit","apeshit","batshit",
  "clusterfuck","mindfuck","brainfuck","fuckwit","fuckface","shitfaced",
  "cocksucker","dickhead","asswipe","shitstain","fucktard","dirtbag","scumbag",
  "sleazebag","douche","pissed","bitchy","slutty","trashy","skanky","fugly",
  "stfu","gtfo","lmfao","wtf","omfg","fml","smfh",
  "arse","arsehole","bellend","bloody","bugger","minger","pillock","plonker",
  "sod","tosser","git","naff","numpty","prat","slag","tit","twit",
  "blimey","crikey","cor","flipping","frigging","blooming",
];
 ...
 */
export function scanForTopics(text: string, blockedTopics: string[]): GuardrailScanResult {
 ...
 */
export function scanForCompetitors(text: string, competitorNames: string[]): GuardrailScanResult {
  const matches: GuardrailMatch[] = [];
 ...
 */
export function scanForProfanity(text: string, customWords?: string[]): GuardrailScanResult {
 ...
 */
export function redactGuardrailMatches(text: string, matches: GuardrailMatch[]): string {
  let result = text;
